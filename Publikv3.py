...
cl = LINETCR.LINE()
cl.login(token="ErfysWw7ee7G6IWKCq0b.RUeiEkB+f8ERc6z9YAKqUW.cvZZXEt5FwTO9RyBwZ9VT1o/huVWHXSRILkhv955PTk=")
cl.loginResult()
...
║ 		  ☆☞ HelpMenu ☜☆
╠══════════════════════
╠KeyCreator  (Menu Creator)
╠KeyAdmin    (Menu Admin)
╠KeyPublic   (Menu Public)
╚═════════════════════"""
public ="""
╔══════════════════════
║ 		  ☆☞ PublicMenu ☜☆
...
"""
Setgroup =""" 
    instagram.com/yuki21_"""
KAC=[cl,ki,ki2]
mid = cl.getProfile().mid
kimid = ki.getProfile().mid
ki2mid = ki2.getProfile().mid
Bots=[mid,kimid,ki2mid]
creator =["ua077ebfd3d38eb6f3c854a603fc48d15"]
admin =["ua077ebfd3d38eb6f3c854a603fc48d15"]
wait = {
    'contact':False,
    'autoJoin':True,
    'autoCancel':False,
            ...
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots:
                ...
                pass
              	...
              	try:
                	cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Jangan Buka Qr Yak!!")
                	...
                	random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Jangan Buka Kode QR Nak!!")
...
#-----------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "ua077ebfd3d38eb6f3c854a603fc48d15"}
                cl.sendMessage(msg)
                rnd = ["Dia Creator Saya","Dia Pemilik Saya"]
                p = random.choice(rnd)
                lang = 'id'
